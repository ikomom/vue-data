          ...
          const list = (optionData.series || []).map((ele, index) => {
            return Object.assign(ele, {
              ...
              markLine: {
                ...
                label: {
                  position: "end",
                  padding: [-10, -100, 10, -80]
                },
                lineStyle: {
                  color: "#B2B2B2"
                },
                data : (() => {
                  const sectionData = (optionData.sections || []).map((ele, index) => {
                    return Object.assign(ele, {
                      name: ele.name,
                      yAxis: ele.yaxis,
                      ...
                      label: {
                        ...
                        textStyle: {
                          fontSize: 14,
                          color: ['竞争I型', '竞争II型'].includes(ele.name) ? "#F0A356" : "#EF766B"
                        },
                      },
                    });
                  });
              ...
              // markLine: {//标线
              //   data: [
              //     { name: '标线一', yAxis: 10000, label:{formatter:'标线一'} },
              //     { name: '标线二', yAxis: 20000, label:{formatter:'标线二'} },
              //     { name: '标线三', yAxis: 30000, label:{formatter:'标线三'} }
              //   ]
              // }
            });
          });
