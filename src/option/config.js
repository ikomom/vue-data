...
export const interOption = {
  ...
  column: [{
    ...
    type: 'select',
    dicData: [
      { label: '无', value: 0 }, { label: 'AES', value: 1 }, { label: 'DES', value: 2 }
    ]
  }, {
    label: '传参类型',
    prop: 'postType',
    type: 'select',
    dicData: [
      { label: '默认', value: -1 }, { label: 'formData', value: 0 }, { label: 'Text-plain', value: 1 }
    ]
  }]
}
...
export const dicOption = {
  ...
  dataType: [{ label: '静态数据', value: 0 }, { label: '动态数据', value: 1 },{ label: '赋值数据', value: 2 }],
  orientList: [{ label: '竖排', value: 'vertical' }, { label: '横排', value: 'horizontal' }],
  dataMethod: [{ label: 'POST', value: 'post' }, { label: 'GET', value: 'get' }],
  encrytType: [{ label: '无', value: 0 }, { label: 'AES', value: 1 }, { label: 'DES', value: 2 }],
  postType: [{ label: 'formData', value: 0 }, { label: 'Text-plain', value: 1 }],
  eventList: ['tabs', 'times', 'singletimes', 'search', 'ztable', 'bshow'],
  dataList: ['common', 'datav', 'text', 'wordcloud', 'img', 'tabs', 'map', 'video', 'pie', 'pictorialbar', 'iframe', 'swiper', 'flop', 'bar', 'line', 'progress', 'table', 'gauge', 'funnel', 'scatter', 'radar', 
    'sticky', 'iconblock', 'sankey', 'kline', 'ztext', 'ztable', 'barline', 'linebar', 'steps', 'times', 'roundblock', 'singletimes', 'search', 'ringnotes', 'bshow'],
  themeList: [{
    label: '默认配色',
    value: 'avue'
  }, {
  ...
  barList: ['bar', 'line'],
  titleList: ['bar', 'pie', 'line', 'radar', 'funnel', 'sankey', 'barline', 'linebar'],
  labelList: ['bar', 'line', 'pie', 'radar', 'scatter'],
  legendList: ['bar', 'pie', 'line', 'radar', 'funnel', 'barline', 'linebar'],
  colorList: ['bar', 'pie', 'line', 'gauge', 'funnel', 'scatter', 'radar', 'barline', 'linebar'],
  tipList: ['bar', 'pie', 'line', 'gauge', 'funnel', 'scatter', 'radar', 'barline', 'linebar'],
  postionList: ['bar', 'line', 'pictorialbar', 'barline', 'linebar'],
  formatterList: ['bar', 'map', 'line', 'pie', 'gauge', 'funnel', 'scatter', 'radar'],
  clickFormatterList: ['map'],
  labelFormatterList: ['bar'],
  stickyList: ['sticky'],
  ringnotesList: ['ringnotes'],
  tabsTypeList: [{
    label: '选项卡',
    value: 'tabs',
  }, {
