      ...
      return Object.assign(
        {
          ...
          borderRadius: this.setPx(this.option.borderRadius || 32),
          backgroundColor: this.option.selectBackground || '#f2f2f2',
        },
        this.styleSizeName
      );
    },
...
.el-select-dropdown{
  ...
  color: #3C3F43 !important;
  &__list{
    box-shadow:0px 12px 16px -4px rgba(0,0,0,0.02),
    0px 8px 15px -4px rgba(0,0,0,0.04),
    0px 4px 13px -4px rgba(0,0,0,0.06);
  ...
  .hover{
    background-color: #3C90FB !important;
    color: #fff !important;
  }
}
